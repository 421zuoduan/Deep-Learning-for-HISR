...
import datetime
from DFTL_model_Huang import DFTL as net
...
def build(args):
    ...
    model = net(args, image_size=args.patch_size, in_channels=3, out_channels=3,
              ...
              depths=[2, 2, 2, 2], sr_ratio=[1, 1, 1, 1], mode="two").cuda()
...
if __name__ == "__main__":
    ...
    model_path = './results/100L/HPT/HPT_hybrid_s2s_pool_hP_res/model_2021-08-09-19-20/.pth.tar'
    ...
    args.experimental_desc = "TwoThreeAttn_huang"
    args.dataset = "100L"
