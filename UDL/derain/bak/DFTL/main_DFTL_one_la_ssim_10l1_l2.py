...
class MixLoss(torch.nn.Module):
    ...
    def __init__(self, reduction='none'):
        ...
        self._ssim = SSIM(size_average=True, data_range=1)
        self.ind = 1
    ...
    def forward(self, x, gt):
        ...
        return {'Loss': _ssim_loss+10*l1_loss+l2_loss, 'ssim_loss': _ssim_loss, 'ssim': ssim_m, "l1_loss": l1_loss}#'bce_loss': w_bce,
    ...
    #     l2_loss * ((_ssim_loss.reshape(-1, 1, 1, 1) / w_s) ** ind + (l1_loss / w_1)+1e-8) ** ind
    #     ##(bce / w_bce) ** ind
    ...
    #             'ssim_loss': w_s, 'ssim': ssim_m}#'bce_loss': w_bce,
...
def train_one_epoch(args, model, criterion, data_loader, optimizer, device, epoch, scaler):
    ...
    for batch, idx in metric_logger.log_every(data_loader, print_freq, header):
        ...
        # metric_logger.update(ssim=g_ssim(add_mean(outputs) / 255.0, gt))
...
if __name__ == "__main__":
    ...
    # os.environ["RANK"] = "0"
    model_path = './results/Fu100H/HPT_new/OneAttn/model_2021-09-05-23-23/.pth.tar'
    # model_path = './results/Fu100H/HPT_new/OneAttn/model_2021-08-30-14-47/747.pth.tar'
    # model_path = './results/DID/HPT_new/OneAttn/model_2021-09-01-18-01/614.pth.tar'
    ...
    parser.add_argument('-b', '--batch-size', default=8*8, type=int,  # 8
    ...
    args.experimental_desc = "OneAttn"
    args.dataset = "Fu100H"
    ...
    '''
    our_loss
    - Averaged stats: lr: 0.000300  grad_norm: 1.327026  Loss: 0.1920 (0.3341261)  l1_loss: 0.0139 (0.0192436)  mse_loss: 0.0249 (0.0281965)  ssim_loss: 0.0769 (0.1349834)  bce_loss: 1.3982 (1.3840090)  ssim: 0.9499 (0.8896116)  psnr: 29.8762 (29.7028947)
    -  * Best validation psnr so far@1 29.7028947 in epoch 0
    - Training time 0:00:20
    
    - Averaged stats: lr: 0.000300  grad_norm: 3.547964  Loss: 0.1647 (0.2534913)  l1_loss: 0.0094 (0.0148771)  mse_loss: 0.0302 (0.0277153)  ssim_loss: 0.0661 (0.1001500)  bce_loss: 1.3402 (1.3853846)  ssim: 0.9583 (0.9201950)  psnr: 34.0337 (31.4379966)
    -  * Best validation psnr so far@1 31.4379966 in epoch 1
    - Training time 0:00:41
    
    - Averaged stats: lr: 0.000300  grad_norm: 0.142015  Loss: 0.0126 (0.0195787)  ssim: 0.9474 (0.8965532)  psnr: 30.7393 (28.5070081)
    -  * Best validation psnr so far@1 28.5070081 in epoch 0
    - Averaged stats: lr: 0.000300  grad_norm: 0.230613  Loss: 0.0081 (0.0139727)  ssim: 0.9592 (0.9373246)  psnr: 35.0778 (31.1532369)
    -  * Best validation psnr so far@1 31.1532369 in epoch 1
    
    
    1e-4
    - Averaged stats: lr: 0.000100  grad_norm: 1.442371  Loss: 0.1166 (0.2116551)  l1_loss: 0.0150 (0.0205257)  mse_loss: 0.0249 (0.0283363)  ssim_loss: 0.0871 (0.1452827)  bce_loss: 1.3983 (1.3840554)  ssim: 0.9386 (0.8803529)  psnr: 29.8337 (29.2720807)
-  * Best validation psnr so far@1 29.2720807 in epoch 0
    - Averaged stats: lr: 0.000100  grad_norm: 4.306936  Loss: 0.1118 (0.1620087)  l1_loss: 0.0108 (0.0158747)  mse_loss: 0.0303 (0.0277756)  ssim_loss: 0.0779 (0.1087193)  bce_loss: 1.3402 (1.3854122)  ssim: 0.9504 (0.9128452)  psnr: 33.0298 (31.0493063)
-  * Best validation psnr so far@1 31.0493063 in epoch 1
    
    
    - Averaged stats: lr: 0.000100  grad_norm: 0.080233  Loss: 0.0165 (0.0212388)  ssim: 0.9253 (0.8854161)  psnr: 28.5897 (27.6522298)
-  * Best validation psnr so far@1 27.6522298 in epoch 0
    - Averaged stats: lr: 0.000100  grad_norm: 0.134132  Loss: 0.0090 (0.0153842)  ssim: 0.9503 (0.9269603)  psnr: 33.8226 (30.5936275)
-  * Best validation psnr so far@1 30.5936275 in epoch 1
    
    128
    - Averaged stats: lr: 0.000300  grad_norm: 4.142554  Loss: 0.1355 (0.1781399)  l1_loss: 0.0147 (0.0175950)  mse_loss: 0.0367 (0.0275382)  ssim_loss: 0.0990 (0.1316765)  bce_loss: 1.3612 (1.3859622)  ssim: 0.9323 (0.8899516)  psnr: 30.1645 (29.8222782)
-  * Best validation psnr so far@1 29.8222782 in epoch 0
- Averaged stats: lr: 0.000300  grad_norm: 2.638299  Loss: 0.0815 (0.1302016)  l1_loss: 0.0097 (0.0132677)  mse_loss: 0.0239 (0.0270655)  ssim_loss: 0.0640 (0.0944300)  bce_loss: 1.4058 (1.3877680)  ssim: 0.9555 (0.9229289)  psnr: 34.2394 (31.5781453)
-  * Best validation psnr so far@1 31.5781453 in epoch 1
