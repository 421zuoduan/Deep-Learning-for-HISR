...
class SSIMLoss(torch.nn.Module):
    ...
    def forward(self, x, gt):
        ...
        return {'Loss': _ssim_loss+l1_loss, 'ssim_loss': _ssim_loss, 'ssim': ssim_m, "l1_loss": l1_loss}#'bce_loss': w_bce,
...
if __name__ == "__main__":
    ...
    # os.environ["RANK"] = "0"
    model_path = './results/Fu100H/HPT_new/OneAttn/model_2021-09-05-22-05/50.pth.tar'
