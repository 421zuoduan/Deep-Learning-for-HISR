...
class EpochRunner():
    ...
    def eval_framework(self, eval_loader, model, criterion):
        ...
        for batch, idx in metric_logger.log_every(eval_loader, 1, header):
            ...
            tensor_cpu = outputs.byte().permute(1, 2, 0).cpu()
...
if __name__ == "__main__":
    ...
    model_path = './results/100L/DETR/detr/model_2021-09-02-21-59/497.pth.tar'
