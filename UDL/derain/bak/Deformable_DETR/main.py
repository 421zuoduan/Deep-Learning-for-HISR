...
def get_args_parser():
    ...
    parser.add_argument('--dim_feedforward', default=512, type=int,#1024
                        help="Intermediate size of the feedforward layers in the transformer blocks")
    parser.add_argument('--hidden_dim', default=128, type=int,#256
                        help="Size of the embeddings (dimension of the transformer)")
    parser.add_argument('--dropout', default=0.1, type=float,
                        help="Dropout applied in the transformer")
    parser.add_argument('--nheads', default=4, type=int,#8
    ...
    parser.add_argument('--coco_path', default='D:/Datasets/coco2017', type=str)
