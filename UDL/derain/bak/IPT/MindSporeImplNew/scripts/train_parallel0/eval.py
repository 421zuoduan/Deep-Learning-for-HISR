...
def eval_net():
    ...
    for arg in vars(args):
        if vars(args)[arg] == 'True':
            ...
            vars(args)[arg] = False
    train_dataset = TrainValDataset(args, name="test", train=False)#SRData(args, name=args.data_test, train=False, benchmark=False)
    ...
    net_m = ipt.IPT(args)
    args.pth_path = './cache/results/edsr_baseline_x2/model_295.ckpt'
    if args.pth_path:
