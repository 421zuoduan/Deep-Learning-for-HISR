...
# Data specifications
parser.add_argument('--dir_data', type=str, default='../MindSporeImpl/cache/data/',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='../test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='DIV2K',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='test100L',
...
# derain
parser.add_argument('--derain', action='store_true', default=True)
