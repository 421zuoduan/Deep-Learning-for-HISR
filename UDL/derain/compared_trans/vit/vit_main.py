...
from common.derain_dataset import derainSession, PSNR_ycbcr, sub_mean, add_mean, quantize
...
class EpochRunner():
    ...
    def eval_framework(self, eval_loader, model, criterion):
        ...
        psnr_list = []
        # for iteration, batch in enumerate(val_loader, 1):
        saved_path = f"./my_model_results/vit/{args.dataset}"
