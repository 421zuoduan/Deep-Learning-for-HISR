...
model_path = f'{script_path}/results/100L/HPT_new/swin/model_2021-09-05-13-56/.pth.tar'
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='SwinIR')
...
parser.add_argument('-b', '--batch-size', default=4, type=int,  # 8
...
# SRData
parser.add_argument('--model', default='swinir',
                    help='model name')
...
args.experimental_desc = "swin_l1"
