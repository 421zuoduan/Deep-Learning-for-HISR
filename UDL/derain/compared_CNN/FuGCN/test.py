...
model_path = './TrainedModel/model-Rain200L' # trained model ./TrainedModel/model-Rain200L

input_path = '../../derain/dataset/original/PReNet_data/Rain100L/rainy/'#'./TestImg/rainL/' # the path of testing images

results_path = './TestImg/result_100L/'  # the path of de-rained results
