...
parser.add_argument('--arch', '-a', metavar='ARCH', default='PReNet')
...
parser.add_argument('-b', '--batch-size', default=18, type=int,  # 8
...
parser.add_argument('--model', default='PReNet',
                    help='model name')
parser.add_argument('--test_every', type=int, default=-2,  # 22,
...
if os_sys == "Linux":
    args.data_dir = '/home/office-409/Datasets/derain'  # /home/office-409
if os_sys == "Windows":
