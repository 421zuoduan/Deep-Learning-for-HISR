...
class DiCNN(nn.Module):
    ...
    def forward(self, x, y):  # x= pan; y = lms

        pan_refine = self.registration(x, y)
...
#         self.others_index_list, self.index_list = test_compared_model(args)
#
...
#
#     model_path = "./results/wv3/Vmx/Unet/model_2021-05-18-20-34/amp_model_best.pth.tar"
