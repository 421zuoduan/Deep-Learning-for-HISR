...
from UDL.hisr.HISR.Swin_baseline.Swin import *
...
class Swinnet(PatchMergeModule):
    def __init__(self, args):
        ...
        self.t = T(img_size=self.img_size, patch_size=1, in_chans=34, embed_dim=32, depths=[2, 4], num_heads=[8, 8], window_size=4)
