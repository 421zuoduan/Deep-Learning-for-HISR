...
parser.add_argument('--name', default='Bidi_kernelattentionv5', type=str)
...
# model_path = f'UDL\\results\\hisr\\Bidi_kernelattentionv3\\cave_x4\\AdaTrans\\Test\\train_on_machine_6\\2000.pth.tar'
