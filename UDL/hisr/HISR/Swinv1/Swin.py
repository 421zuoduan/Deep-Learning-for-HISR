...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        self.KernelAttention = KernelAttention(dim//2, input_resolution[0], num_heads, ka_win_num=4, kernel_size=3, stride=1, padding=1, qkv_bias=qkv_bias, qk_scale=qk_scale, attn_drop=attn_drop, proj_drop=drop)
