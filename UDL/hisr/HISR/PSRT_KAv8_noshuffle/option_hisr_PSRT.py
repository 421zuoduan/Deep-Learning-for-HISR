...
parser.add_argument('--name', default='PSRT_KAv8_noshuffle', type=str)
...
# model_path = 'UDL/results/hisr/PSRT_KAv4_noshuffle/cave_x4/AdaTrans/Test/model_2023-10-18-22-00/2000.pth.tar'
