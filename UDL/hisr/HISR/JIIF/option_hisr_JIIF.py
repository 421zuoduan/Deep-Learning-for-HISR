...
parser.add_argument('--name', default='JIIFm', type=str)

model_path = f'{root_dir}/results/{cfg.task}/JIIFm/cave_x4/AdaTrans/Test/model_2023-03-27-21-17/1000.pth.tar'
...
parser.add_argument('--dataset', default='cave_x4', type=str,
                    choices=['cave_x4', 'harvard_x4', 'pavia_x4', 'cave_x8'],
                    help="Datasets")
