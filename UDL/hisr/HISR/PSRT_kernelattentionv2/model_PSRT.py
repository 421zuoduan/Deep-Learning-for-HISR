...
from UDL.hisr.HISR.PSRT_kernelattentionv2.psrt import *
...
class PSRTnet(PatchMergeModule):
    def __init__(self, args):
        ...
        self.w = Block(out_num=2, inside_num=3, img_size=self.img_size, in_chans=34, embed_dim=self.embed, head=8, win_size=8, ka_win_size=16, k_size=3)
