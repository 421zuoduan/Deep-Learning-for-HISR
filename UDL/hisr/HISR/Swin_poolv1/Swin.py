...
class WindowInterAttention(nn.Module):
    ...
    def __init__(self, input_resolution, dim, ka_win_num, window_size, k_size, k_stride, k_padding, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        super().__init__()
    ...
    def forward(self, x):
        ...
        # global_kernel:  B*C, nW, k_size, k_size
