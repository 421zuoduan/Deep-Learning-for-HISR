...
parser.add_argument('--name', default='PSRT_kernelattentionv3', type=str)
parser.add_argument('--test_epoch', default='2001', type=int)

# model_path = 'UDL/results/hisr/PSRT_kernelattentionv1/cave_x4/AdaTrans/Test/model_2023-09-20-00-56/200.pth.tar'
model_path = f'{root_dir}/results/{cfg.task}/PSRT_kernelattentionv1/cave_x4/Test/model_2023-08-12-11-14/1985.pth.tar'
