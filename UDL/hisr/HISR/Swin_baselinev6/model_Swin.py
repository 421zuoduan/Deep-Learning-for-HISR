...
from UDL.hisr.HISR.Swin_baselinev6.Swin import *
...
class Swinnet(PatchMergeModule):
    def __init__(self, args):
        ...
        self.t = T(img_size=self.img_size, patch_size=1, in_chans=34, embed_dim=self.embed_dim, depths=[2, 4], num_heads=[16, 16], window_size=16)
