...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, ka_win_num=4, shift_size=0,
        ...
        self.attn = WindowAttention(
            dim//2, window_size=to_2tuple(self.window_size), num_heads=branch_num_heads,
    ...
    def forward(self, x, x_size):
        ...
        # partition windows
        x_windows = window_partition(x_wa, self.window_size)  # nW*B, win_size, win_size, C/2  N*C/2->C/2
        x_windows = x_windows.view(-1, self.window_size * self.window_size, C//2)  # nW*B, win_size*win_size, C/2
