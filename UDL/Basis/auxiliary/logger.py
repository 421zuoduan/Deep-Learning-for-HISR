...
def get_logger(name, cfg, cfg_name, phase='train', log_level=logging.INFO, file_mode='w'):  # log_file=None,
    ...
    final_output_dir = root_output_dir / cfg.name / dataset / model / cfg_name
    if cfg.eval:
    ...
    if cfg.eval:
        ...
        # tensorboard_log
        tensorboard_log_dir = root_output_dir / cfg.name / Path(cfg.log_dir) / dataset / model / cfg_name
        # if not dist_print:
        print('=> creating tfb logs {}'.format(tensorboard_log_dir))
        tensorboard_log_dir.mkdir(parents=True, exist_ok=True)

    return setup_logger(name, final_log_file), str(final_output_dir), str(model_save_dir), str(
