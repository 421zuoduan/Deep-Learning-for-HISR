...
def panshaprening_cfg():
    ...
    if platform.system() == 'Linux':
        args.data_dir = '/home/rongmeiyang/projects/dataset/pansharpening'
    if platform.system() == "Windows":
        args.data_dir = 'G:/dl/Data/pansharpening'
...
def derain_cfg():
    ...
    args.scale = [1]
    if platform.system() == 'Linux':
        args.data_dir = '/home/rongmeiyang/projects/dataset/derain'
    if platform.system() == "Windows":
        args.data_dir = 'G:/dl/Data/derain'
    args.best_prec1 = 10000
    args.best_prec5 = 10000
    args.metrics = 'min'
    args.task = "derain"
...
def sisr_cfg():
    ...
    if platform.system() == 'Linux':
        args.data_dir = '/home/rongmeiyang/projects/dataset/derain'
    if platform.system() == "Windows":
        args.data_dir = 'E:/gitdoc/udl/UDL/sisr/data'
    args.best_prec1 = 10000
    args.best_prec5 = 10000
    args.metrics = 'min'
    args.task = "sisr"
