# -*- encoding: utf-8 -*-
"""
@File    : option_hisr_Swin_SaR.py
@Time    : 2022/3/10 16:39
@Author  : Shangqi Deng
...
parser.add_argument('--name', default='Bottleneck', type=str)

model_path = f'{root_dir}/results/{cfg.task}/Bottleneck/wv3/AdaTrans/Test/model_2022-07-07-10-52/amp_model_best.pth.tar'
