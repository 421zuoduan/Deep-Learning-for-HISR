...
from auxiliary.utils import MetricLogger, SmoothedValue, set_random_seed

# from pytorch_msssim.pytorch_msssim import SSIM
from cal_ssim import SSIM
from dataset import PSNR, PSNR_t
from auxiliary.logger import create_logger, log_string
import datetime
from model_cvpr import DFTL as net
...
def main(args):
    ...
    # if rank == 0:
    #     # from torch.auxiliary.collect_env import get_pretty_env_info
    #     # logger.debug(get_pretty_env_info())
    #     # logger.debug(net)
    #     logger.info("\n\n\n            =======  TRAINING  ======= \n\n")
    #     logger.info(auxiliary.count_parameters(net))
    # if rank == 0:
    #     logger.info(
...
if __name__ == "__main__":
    ...
    parser.add_argument('-b', '--batch-size', default=184, type=int,  # 8
